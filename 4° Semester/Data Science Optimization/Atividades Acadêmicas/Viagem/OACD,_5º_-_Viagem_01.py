...
# Exemplo 1: Minimizar o Custo Total
...
modelo = ConcreteModel()  # Cria um modelo concreto 
# (onde os dados são definidos diretamente)

# --- 3. CONJUNTOS DE OPÇÕES ---
# Vamos criar "listas" (conjuntos) para as opções de ida e volta.

modelo.I = Set(initialize=opcoes_ida.keys())  
# Conjunto I: 'A', 'B', 'C' (opções de ida)
modelo.J = Set(initialize=opcoes_volta.keys()) 
# Conjunto J: 'D', 'E' (opções de volta)
...
# Escolhe o GLPK para resolver o problema
