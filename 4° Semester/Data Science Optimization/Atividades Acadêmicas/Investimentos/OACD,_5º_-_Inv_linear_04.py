# -*- coding: utf-8 -*-
"""
Created on Wed Mar 12 10:38:48 2025
...
m.C5 = pyo.Constraint(expr=m.R['D'] == 0.00003 * m.C['D']) # Retorno de D linearizado 0,003%
...
print("=== Resultados de Investimento (Linear com GLPK) ===")
